...
if(isset($_SESSION['Rut'])){
    $Rut=$_SESSION['Rut'];
    $sql= "SELECT Contra FROM usuarios WHERE Rut='$Rut'";
    $query=mysqli_query($con,$sql);
    while($contraseña=mysqli_fetch_array($query)){
        $mostrar=$contraseña['Contra'];
        $Contexto="su contraseña es: ";
...
<html lang="en">
    ...
    <div class="Especial">
              ...
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                  <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    <li class="nav-item">
                      <div><a aria-current="page" href="inicioSecion.php" 
        ...
        <div class="Iniciar-sesion">
            <div id="Registro"><?php echo $Contexto; echo utf8_decode($mostrar);?></div>
            <div class="Datos">    
                <form action="validar.php" method="POST">
                    ...
                    contraseña:<input type="password" name="Contra" placeholder="Contra" 
                    required=true style="background-color: goldenrod;"><br></br>
                    ...
                    <button type="submit" name="entrar" style="background-color: goldenrod;" value="1">Ingresar</button>
                </form>
            </div>
            <a id="crear"href="Registro.php"><input type="button" value="Registrarse" style="background-color: red;"></a>
            <a id="crear"href="Recuperar_contra.php"><input type="button" value="Recuperar contraseña" style="background-color: white;"></a>
        </div>
